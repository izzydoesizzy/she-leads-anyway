...
const SolutionIntro: React.FC = () => {
  const benefits = [
    "Build presence that commands respect",
    "Strengthen influence with senior leaders and decision-makers", 
    "Lead high-stakes conversations with clarity and courage",
    "Thrive in leadership without burning out",
    "Design a leadership identity rooted in authenticity"
  ];
