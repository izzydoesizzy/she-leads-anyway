...
const Vision: React.FC = () => {
  ...
  return <section id="vision" className="border-t bg-gradient-primary/5">
      <div className="container mx-auto py-16">
        <div className="text-center">
          <h2 className="text-4xl font-bold leading-tight text-4xl md:text-4xl">The Solution: She Leads Anyway™</h2>
        </div>
