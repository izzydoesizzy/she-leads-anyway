      ...
      <GradientSpotlight className="relative">
        <div className="container mx-auto grid items-center gap-10 py-16 md:grid-cols-2 md:py-24">
          <div className="space-y-6 animate-enter">
            ...
            <p className="text-base text-muted-foreground">Backed by 30+ years of corporate human resources leadership. Trusted by women of colour leaders navigating high-stakes spaces with authenticity.</p>
